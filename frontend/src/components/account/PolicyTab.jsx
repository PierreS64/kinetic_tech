...
import { ChevronRight, ShoppingBag, Tag, Heart, X, ShieldCheck, RotateCcw, CheckCircle2, Lock, Send, HelpCircle, AlertTriangle } from 'lucide-react';
  ...
  return (
              ...
              <div  style={{ borderRadius: 'var(--rounded-lg)', padding: '24px' }} className="glass-panel">
                ...
                <div  style={{ fontSize: '13px', color: 'var(--color-on-surface-variant)', lineHeight: '1.7', display: 'flex', flexDirection: 'column', gap: '16px' }} className="static-policy-content">
                  <div>
                    <h4 style={{ fontSize: '14px', fontWeight: '700', color: 'var(--color-on-surface)', marginBottom: '6px' }}>1. Quy định đổi trả trong 7 ngày đầu</h4>
                    <p>
                  ...
                  <div>
                    <h4 style={{ fontSize: '14px', fontWeight: '700', color: 'var(--color-on-surface)', marginBottom: '6px' }}>2. Điều kiện bảo hành tiêu chuẩn</h4>
                    <p>
                  ...
                  <div>
                    <h4 style={{ fontSize: '14px', fontWeight: '700', color: 'var(--color-on-surface)', marginBottom: '6px' }}>4. Thời gian tiếp nhận và xử lý sự cố</h4>
                    <p>
